...
<div class="timedUnderArea <?php echo $cta_border_desktop . $cta_border_mobile; ?> wi-cta-tab <?php echo $show_main_cta ? 'wi-cta-tab-keep' : ''; ?>" id="wi-cta-0-tab" style="display: <?php echo $show_main_cta ? "block" : "none"; ?>" data-cta-index="default">
    <div id="orderBTNCopy">
        <?php
//        if ($show_main_cta) {
