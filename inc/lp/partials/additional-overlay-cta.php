...
foreach ($additional_autoactions as $index => $additional_autoaction) {
    ...
    ?>
    <div  id="wi-cta-<?php echo $index; ?>-tab" class="additional_autoaction_item timedUnderArea <?php echo $cta_border_desktop . $cta_border_mobile; ?> timedUnderAreaOverlay wi-cta-tab" style="display: none; <?php echo $max_width; ?>">
